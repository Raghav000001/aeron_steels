    ...
    <>
      ...
      <AnimatedSection muted>
        <div className="text-center mb-12">
          <span className="font-mono text-[10px] text-primary tracking-[0.3em] uppercase animate-on-scroll">Key Features</span>
          <h2 className="text-2xl md:text-3xl font-heading font-bold text-white mt-3 animate-on-scroll">Why Choose Our H&amp;T Steel Strips</h2>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          {PRODUCT.features.map((f) => (
            <div key={f.title} className="flex items-start gap-4 p-6 rounded-2xl glass-panel animate-on-scroll">
              ...
              <div>
                <h3 className="text-base font-heading font-bold text-white mb-1">{f.title}</h3>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start">
          ...
          <div className="aspect-[4/3] rounded-2xl overflow-hidden glass-panel flex items-center justify-center animate-on-scroll">
            <div className="text-center p-8">
              ...
              <p className="text-sm text-on-surface-variant/70">Precision Engineered</p>
            </div>
          </div>
        </div>
      </AnimatedSection>
