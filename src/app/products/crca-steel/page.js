    ...
    <>
      ...
      <AnimatedSection muted>
        <div className="text-center mb-12">
          <span className="text-sm font-semibold uppercase tracking-widest text-primary animate-on-scroll">Key Advantages</span>
          <h2 className="text-2xl md:text-3xl font-heading font-bold text-heading mt-3 animate-on-scroll">Why Choose Our CRCA Steel</h2>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          {PRODUCT.advantages.map((adv) => (
            <div key={adv.title} className="flex items-start gap-4 p-6 rounded-2xl bg-white border border-border/40 shadow-sm animate-on-scroll">
              ...
              <div>
                <h3 className="text-base font-heading font-bold text-heading mb-1">{adv.title}</h3>
                <p className="text-sm text-body leading-relaxed">{adv.desc}</p>
              </div>
            </div>
          ))}
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start">
          ...
          <div className="aspect-[4/3] rounded-2xl overflow-hidden shadow-lg bg-gradient-to-br from-primary/5 to-primary-accent/5 flex items-center justify-center animate-on-scroll">
            <div className="text-center p-8">
              ...
              <p className="text-sm text-body/70">Premium CRCA Steel</p>
            </div>
          </div>
        </div>
      </AnimatedSection>
