    ...
    <>
      ...
      <AnimatedSection muted>
        <div className="text-center mb-14">
          <span className="font-mono text-[10px] text-primary tracking-[0.3em] uppercase animate-on-scroll">Our Commitment</span>
          <h2 className="text-3xl md:text-[40px] font-heading font-bold text-white mt-3 leading-tight uppercase tracking-tighter animate-on-scroll">
            ...
            <span className="text-primary italic">It&apos;s Our Culture</span>
          </h2>
          <p className="text-on-surface-variant mt-4 max-w-2xl mx-auto leading-relaxed animate-on-scroll">
      ...
      <AnimatedSection>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          <div className="aspect-[4/3] rounded-2xl overflow-hidden glass-panel flex items-center justify-center order-2 lg:order-1 animate-on-scroll">
            <div className="text-center p-8">
              <div className="size-20 mx-auto rounded-full bg-primary/10 flex items-center justify-center mb-4">
                <ShieldCheck className="size-10 text-primary" />
              </div>
              <p className="text-sm text-on-surface-variant/70">ISO 9001:2015 Certified</p>
            </div>
          </div>
          <div className="order-1 lg:order-2">
            <span className="font-mono text-[10px] text-primary tracking-[0.3em] uppercase animate-on-scroll">Why Quality Matters</span>
            <h2 className="text-3xl md:text-[40px] font-heading font-bold text-white mt-3 leading-tight uppercase tracking-tighter animate-on-scroll">
              Rigorous Testing at{" "}
      ...
      <AnimatedSection muted>
        <div className="text-center mb-14">
          <span className="font-mono text-[10px] text-primary tracking-[0.3em] uppercase animate-on-scroll">Our Process</span>
          <h2 className="text-3xl md:text-[40px] font-heading font-bold text-white mt-3 uppercase tracking-tighter animate-on-scroll">6-Stage Quality Process</h2>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {STAGES.map((stage) => (
            <div key={stage.step} className="relative glass-panel rounded-2xl p-8 animate-on-scroll">
              ...
              <h3 className="text-lg font-heading font-bold text-white mb-2 relative">{stage.title}</h3>
              <p className="text-sm text-on-surface-variant leading-relaxed relative">{stage.desc}</p>
            </div>
          ))}
        </div>
      </AnimatedSection>
      ...
      <AnimatedSection>
        <div className="text-center mb-14">
          <span className="font-mono text-[10px] text-primary tracking-[0.3em] uppercase animate-on-scroll">Certifications</span>
          <h2 className="text-3xl md:text-[40px] font-heading font-bold text-white mt-3 uppercase tracking-tighter animate-on-scroll">Standards We Meet</h2>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {CERTIFICATIONS.map((cert) => (
            <div key={cert.name} className="flex items-start gap-4 p-6 rounded-xl glass-panel transition-all animate-on-scroll">
              <div className="shrink-0 size-10 rounded-lg bg-primary/10 text-primary flex items-center justify-center">
                <ShieldCheck className="size-5" />
              </div>
              <div>
                <h3 className="text-base font-heading font-bold text-white">{cert.name}</h3>
